...
public class UserValue {
    ...
    public record UserDetailData(Long id, String name, String email, String type, String sex, String birthDate, String phoneNumber, String createdAt, String updatedAt) {
        ...
        public static UserDetailData of(User u) {
            return new UserDetailData(u.getId(), u.getName(), u.getEmail(), u.getType(), u.getSex(),
